...
(function () {
    var dict = {
        ...
        'hero.subheadline': '協助企業釐清構思、打造實用的數碼工具，並驗證新的市場機會 — 特別是希望進入香港、日本及新加坡的食品品牌，主力以香港及日本為主。',
        'hero.tag1': '商業分析',
        'hero.tag2': '數碼開發及自動化',
        ...
        'why.title': '這如何幫到你',
        'why.lead': '<p>我的背景結合金融營運、業務流程改善、自動化，以及香港、日本及新加坡之間的跨境溝通經驗。</p><p>我並非大型顧問公司。我最適合與創辦人或小型團隊合作 — 需要一位實際的人：能分析現況、整理下一步、打造實用的數碼工具，並協助項目向前推進。</p>',
        'why.b1.title': '降低不確定性',
        'why.b1.text': '在大額投入之前，先取得關於市場契合度、競爭對手、定價及可行推出路徑的清晰資訊。',
        'why.b2.title': '加快推進',
        'why.b2.text': '將構思轉化為研究、頁面、聯繫材料、工作流程及可測試的具體行動。',
        'why.b3.title': '更清晰溝通',
        'why.b3.text': '將業務構思轉化為清晰的數碼材料、本地化文案，以及合作夥伴或客戶能理解的實用文件。',
        'why.b4.title': '減省人手工作',
        'why.b4.text': '對於現有業務，可將重複工作自動化、優化工作流程，讓團隊專注於更高價值的工作。',
